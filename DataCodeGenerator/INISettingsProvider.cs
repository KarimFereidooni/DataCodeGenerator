...
namespace DataCodeGenerator
{
    public class INISettingsProvider : SettingsProvider
    {
        ...
        public INISettingsProvider(string iniFileName, string section)
        {
            ...
            this.INIFile = new DataCodeGenerator.INIFile(System.IO.Path.Combine(System.IO.Path.GetDirectoryName(System.Windows.Forms.Application.ExecutablePath), iniFileName));
        }
        ...
        private DataCodeGenerator.INIFile _INIFile;
        public DataCodeGenerator.INIFile INIFile
        {
            get
            {
                return _INIFile;
